...
Future<void> main(List<String> args) async {
  if (args.length < 2) {
    print('Usage: dart run bin/run.dart <input.pdf> <output.csv> [--pdfjs] [--shooter-list <file.pdf>]');
    exit(2);
  }
  ...
  // If a shooter list was provided, parse and apply classification mapping
